 ...
 /* 
  ...
  function pintarCheckboxs(eventos) {
    ...
    categories.forEach(category => {
      ...
      checkbox.innerHTML = `
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="checkbox" value="${category}" id="checkbox-categorias" name="checkcategory">
          <label class="form-check-label" for="checkbox-categorias">
            ${category}
          </label>
        </div>
      `;
